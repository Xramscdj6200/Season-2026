...
class TunerConstants:
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 4.24

    # Every 1 rotation of the azimuth results in _couple_ratio drive motor turns;
    # This may need to be tuned to your individual robot
    _couple_ratio = 5.4

    _drive_gear_ratio = 6.821052631578947
    _steer_gear_ratio = 12.1
    _wheel_radius: units.meter = inchesToMeters(1.875)
    ...
    _front_left_encoder_offset: units.rotation = -0.345458984375
    ...
    _front_right_encoder_id = 23
    _front_right_encoder_offset: units.rotation = 0.425537109375
    ...
    # Back Left
    _back_left_drive_motor_id = 41
    _back_left_steer_motor_id = 42
    _back_left_encoder_id = 33
    _back_left_encoder_offset: units.rotation = 0.34130859375
    ...
    _back_right_encoder_offset: units.rotation = 0.478759765625
